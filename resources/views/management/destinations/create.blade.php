        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 text-gray-900">
                <div class="flex justify-between items-center mb-6">
                    <h2 class="text-2xl font-bold">Add New Destination</h2>
                ...
                <form action="{{ route('admin.destinations.store') }}" method="POST" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" name="code" id="code" value="{{ old('code') }}" required maxlength="5" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500 p-2 uppercase" placeholder="e.g. JKT">
                        ...
                        <div>
                            ...
                            <input type="text" name="city_name" id="city_name" value="{{ old('city_name') }}" required class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500 p-2" placeholder="e.g. Jakarta">
                        </div>
                    </div>
