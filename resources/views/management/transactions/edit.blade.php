        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 text-gray-900">
                <div class="flex justify-between items-center mb-6">
                    ...
                    <a href="{{ route('admin.transactions') }}" class="text-gray-600 hover:text-gray-900">Back to List</a>
                </div>
                ...
                <form action="{{ route('admin.transactions.update', $transaction->id) }}" method="POST" class="space-y-6">
                    ...
                    <div>
                         ...
                         <p class="text-xs text-gray-500 mt-1">Changing status to "Success" will also update the related Ticket status.</p>
                    </div>
