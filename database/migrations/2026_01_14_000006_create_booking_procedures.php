...
return new class extends Migration
{
    ...
    public function up()
    {
        DB::unprepared("
            ...
            DROP PROCEDURE IF EXISTS sp_create_booking_admin(TEXT, TEXT, TEXT, DATE, TEXT[], TEXT[], TEXT, TEXT, TEXT, TEXT, TEXT);
            ...
            BEGIN
                ...
                IF v_account_id IS NULL THEN
                    INSERT INTO accounts (id, first_name, last_name, email, password_hash, account_type_id, created_at, updated_at)
                    VALUES (
                        NULL, -- ID is auto-generated by Trigger set_account_id
                        p_customer_name, 
                        '', 
                        p_customer_email, 
                        p_default_password, 
                        p_customer_role_id::BIGINT, 
                        NOW(), 
                        NOW()
                    )
                ...
                SELECT get_next_date_sequence('BK_' || TO_CHAR(NOW(), 'YYYY')) INTO v_booking_seq;
